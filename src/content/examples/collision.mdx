...
公式ドキュメント  
https://docs.flame-engine.org/latest/flame/collision_detection.html#hascollisiondetection

API リファレンス  
https://pub.dev/documentation/flame/latest/game/HasCollisionDetection-mixin.html
