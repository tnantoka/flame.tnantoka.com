...
公式ドキュメント  
https://docs.flame-engine.org/latest/flame/components.html#scale  
https://docs.flame-engine.org/latest/flame/components.html#component-lifecycle

API リファレンス  
https://pub.dev/documentation/flame/latest/components/PositionComponent/scale.html  
https://pub.dev/documentation/flame/latest/game/FlameGame/onGameResize.html
