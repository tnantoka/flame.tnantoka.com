...
<DocLink
  reference="https://github.com/flame-engine/flame/blob/v1.10.0/packages/flame/lib/src/components/timer_component.dart"
  label="内部実装"
/>
<DocLink
  reference="https://github.com/flame-engine/flame/blob/v1.10.0/packages/flame/lib/src/timer.dart"
  label="内部実装"
/>
